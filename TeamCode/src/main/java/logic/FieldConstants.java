...
public class FieldConstants {
    ...
    public static final Pose2D BLUE_START_POSE =
            new Pose2D(
                    DistanceUnit.INCH,
                    FIELD_WIDTH / 2 - HardwareConstants.ROBOT_SIZE.toInches() / 2,
                    -TILE_WIDTH / 2,
                    AngleUnit.DEGREES,
                    180);
    ...
    public static final Pose2D AUTO_MODE_SHOOT_POS_BLUE =
            new Pose2D(
                    DistanceUnit.INCH, -TILE_WIDTH / 2, -TILE_WIDTH / 2, AngleUnit.DEGREES, -135);
    public static final Pose2D AUTO_MODE_SHOOT_POS_RED =
            new Pose2D(DistanceUnit.INCH, -TILE_WIDTH / 2, TILE_WIDTH / 2, AngleUnit.DEGREES, 135);

    public static final Pose2D AUTO_MODE_LEAVE_POS_BLUE =
            new Pose2D(DistanceUnit.INCH, TILE_WIDTH / 2, -TILE_WIDTH / 2, AngleUnit.DEGREES, -90);
    ...
    public static final Pose2D BLUE_ARTIFACT_FRONT_ROW_ENTRY_POSE =
            new Pose2D(DistanceUnit.INCH, TILE_WIDTH * 1.5, -30.0, AngleUnit.DEGREES, 270);
    public static final Pose2D BLUE_ARTIFACT_MIDDLE_ROW_ENTRY_POSE =
            new Pose2D(DistanceUnit.INCH, TILE_WIDTH * 0.5, -30.0, AngleUnit.DEGREES, 270);
    ...
    public static final Pose2D RED_ARTIFACT_FRONT_ROW_ENTRY_POSE =
            new Pose2D(DistanceUnit.INCH, TILE_WIDTH * 1.5, 30.0, AngleUnit.DEGREES, 90);
    public static final Pose2D RED_ARTIFACT_MIDDLE_ROW_ENTRY_POSE =
            new Pose2D(DistanceUnit.INCH, TILE_WIDTH * 0.5, 30.0, AngleUnit.DEGREES, 90);
